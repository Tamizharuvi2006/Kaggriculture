"""Direct Synchronous Paired A/B Benchmark: Candidate L+ vs Frozen V4.1 Master.

Evaluates Candidate L+ vs Frozen V4.1 across 40 Paired Matches on Seeds 3000-3009 (10 paired matches per archetype):
...
def main():
    ...
    print("=" * 95)
    print(" Launching 40 Paired Matches (120 Total Matches, Seeds 3000-3009)...")
    ...
    seeds = range(3000, 3010)  # 10 seeds per archetype = 40 paired matches

    results = []
    count = 0
    total_matches = len(archetypes) * len(seeds)
    ...
    for arch_name in archetypes:
        ...
        for seed in seeds:
            ...
            print(f" Completed Seed {seed} vs {arch_name:20} | L+: ${lplus_w:9.2f} | V4.1: ${v41_w:9.2f} | Delta: +${delta:9.2f}")
    ...
    print("\n" + "=" * 95)
    print(" PAIRED A/B RESULTS BY OPPONENT ARCHETYPE (10 SEEDS EACH)")
    print("=" * 95)
    ...
    print("=" * 95)
    print(f" OVERALL COMBINED A/B BENCHMARK (40 PAIRED MATCHES / 120 TOTAL MATCHES):")
