...
def _v18_closed_loop_action(obs, step):
    ...
    if wealth_delta >= 40000.0:
        ...
        comp_regime = "TRAILING"           # RECOVERY COMPOUNDING (85% Reinvest)
    else:
        comp_regime = "SEVERELY_TRAILING"   # 🚨 RECOVERY MODE ($40k vs $120k - 95% High Risk)

    # Capital Velocity & $200K Ceiling-Seeking Trigger Condition
    ...
    # Action Selection: HIGH CONFIDENCE -> V5 Ceiling Engine Override; LOW/MEDIUM -> Candidate L+++ Guardian Fallback
    if confidence == "HIGH" and regime == "MAX_COMPOUNDING":
        # 🚀 MAX_COMPOUNDING Mode: Accelerate output to break $200k ceiling
