...
def _v18_closed_loop_action(obs, step):
    ...
    confidence = "LOW"
    if regime in ("WHEAT_GLUT", "ENDGAME", "MILK_PREMIUM"):
        confidence = "HIGH"
    elif regime == "LOW_LIQUIDITY" and own_money >= 500:
        confidence = "MEDIUM"

    # Action Selection: HIGH CONFIDENCE -> Adaptive Override; LOW/MEDIUM -> Candidate L+++ Guardian Fallback
    if confidence == "HIGH" and regime == "WHEAT_GLUT":
