...
def _v18_closed_loop_action(obs, step):
    ...
    if step_val >= 710:
        ...
        regime = "WHEAT_GLUT"
    elif comp_regime == "SEVERELY_TRAILING" or is_high_opportunity:
    ...
    confidence = "LOW"
    if regime in ("WHEAT_GLUT", "ENDGAME", "MILK_PREMIUM", "RECOVERY_OPPORTUNITY"):
        confidence = "HIGH"
    elif regime == "LOW_LIQUIDITY" and own_money >= 500:
        confidence = "MEDIUM"

    # Action Selection: HIGH CONFIDENCE -> Opponent-Aware EV Override; LOW/MEDIUM -> Candidate L+++ Guardian Fallback
    if confidence == "HIGH" and regime == "RECOVERY_OPPORTUNITY":
        # 🚨 RECOVERY MODE / High Opportunity: Maximize EV action selection & multi-crop compounding
