//! EXP179 — 10,000-Match Validation Harness for Neural Behavioral Cloning & Hierarchical Policy vs AdaptiveTerminal.

use fastsim::engine::state::GameState;
use fastsim::engine::step::step_game;
use fastsim::policies::{AdaptiveTerminalPolicy, NeuralBCPolicy, Policy};
use rayon::prelude::*;
use std::time::Instant;

fn main() {
    println!("================================================================================");
    println!("EXP179 — 10,000 PAIRED MATCHES: NEURAL BC HIERARCHICAL POLICY VS ADAPTIVE TERMINAL");
    println!("================================================================================");

    let hero = NeuralBCPolicy::new();
    ...
    println!("Executing {} paired matches on 12 CPU threads...", tasks.len());
    let t0 = Instant::now();
