//! EXP180 — 200-Match Sanity Test for Target Dispatcher & Deterministic Router vs Adaptive Control.
...
fn main() {
    println!("================================================================================");
    println!("EXP180 — 200-MATCH SANITY TEST: TARGET DISPATCH & DETERMINISTIC ROUTER");
    println!("================================================================================");
    ...
    println!("Running {} paired sanity matches on 12 CPU threads...", tasks.len());
    let t0 = Instant::now();
