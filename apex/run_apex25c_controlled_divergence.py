"""APEX 2.5-C Controlled Safe Divergence & Feature Attribution Benchmark.
"""
...
def run_controlled_divergence_benchmark():
    print("====================================================================================================", flush=True)
    print("🔥 APEX 2.5-C CONTROLLED SAFE DIVERGENCE & FEATURE ATTRIBUTION BENCHMARK", flush=True)
    print("====================================================================================================", flush=True)
    ...
    for seed in all_seeds:
        ...
        # Record match outcome in policy
        ...
        results.append(res)
        print(f"Seed {seed:<10} | L+: ${ctrl_wealth:10,.2f} | APEX 2.5-C: ${apex_wealth:10,.2f} | Margin: ${margin:+10,.2f} | {status} | Traces: {metrics['total_telemetry_traces']}", flush=True)
    ...
    print("\n====================================================================================================", flush=True)
    print("🏆 APEX 2.5-C CONTROLLED DIVERGENCE & FEATURE ATTRIBUTION REPORT", flush=True)
    print("====================================================================================================", flush=True)
    ...
    print(f"Executed Controlled Divergences   : {final_metrics['divergences']}", flush=True)
    print("----------------------------------------------------------------------------------------------------", flush=True)
...
if __name__ == "__main__":
    run_controlled_divergence_benchmark()
