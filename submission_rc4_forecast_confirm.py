...
def _crop_plan(day):
    ...
    # RC4: Forecast -> Confirm -> Act (Policy C: 2-Plot Reservation)
...
def _observe_opponent(obs):
    ...
    # RC4: Stage 2 Confirmation — Track Market Inventory & Velocity (ΔI)
    inv_straw = int(inventory.get("STRAWBERRY", 10000))
    delta_inv = inv_straw - _PREV_STRAW_INV
    _PREV_STRAW_INV = inv_straw
    if _POTENTIAL_STRAWBERRY_RISK and day >= 12 and not _FLOOD_CONFIRMED:
