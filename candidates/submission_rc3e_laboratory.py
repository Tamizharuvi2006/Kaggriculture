...
def _market_orders(obs):
    ...
    wheat_feed_buffer = 0 if day >= 29 else (animal_count * 1 if day >= 28 else animal_count * 2 + 2)
    ...
    # === 3. TERMINAL REALIZATION & CAPITAL CONSERVATION (RC3-E) ===
    # On Days 27-29, cease all capital expansion (seeds, land, animals).
    # All cash and order slots are reserved for selling harvests and operating labor!
    if day >= 27:
