...
def _market_orders(obs):
    ...
    # Dynamic Feed Protection: maintain 2-day on-farm grain buffer
    ...
    critical_target = min(target_hires, 4 if day <= 1 else 5 if day <= 3 else 6 if day <= 5 else 8 if day <= 7 else 10 if day <= 10 else 13)
