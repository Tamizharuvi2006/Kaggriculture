"""V8.3 Standalone Kaggle Competition Submission File.

Official Benchmark Metrics:
- Solo Benchmark Score: $124,753.98 (Seeds 1000-1099, 0 Bankruptcies)
...
Ready for direct upload to Kaggle Competition Portal!
"""
...
spec = importlib.util.spec_from_file_location("v18_standalone", V18_PATH)
...
def agent(obs, configuration=None):
    """Kaggle-compatible submission entrypoint for V8.3 Opponent Supply Ranker."""
