...
def _crop_plan(day):
    ...
    # 1. Calculate feed plot requirement (1 wheat tile yields 1.5 wheat/day)
    # Dedicate 4 to 6 plots early, 6 to 8 later: enough to feed the herd with steady town sales
    feed_wheat_plots = 4 if day <= 8 else 6
    surplus_wheat_plots = 2 if p_wheat >= 30.0 else 0
