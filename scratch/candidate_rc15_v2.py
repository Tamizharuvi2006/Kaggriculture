        ...
        for x, tile in enumerate(row):
            ...
            if tile.get("animal") in ANIMALS:
                ...
                if tile.get("fertilizer_available", False):
                    tasks.append(_task(3, (x, y), ["COLLECT_FERTILIZER"], None, "fertilizer", p_fert * 1.2))
    ...
    while pending and free:
        ...
        for unit in free:
            ...
            for j, task in enumerate(pending):
                ...
                # Routine chores prefer local quadrant; pasture fertilizer collection strictly local (friction = 8 turns)
...
def _market_orders(obs):
    ...
    # Active Fertilizer Monetization: reserve up to 6 for active fertilization, monetize all excess!
