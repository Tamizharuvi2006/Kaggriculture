...
print("=" * 105)
print("     OFFICIAL 5-SEED GAUNTLET: RC2 CONTROL vs RC3-A LABORATORY CANDIDATE     ")
print("=" * 105)

rc2_scores, rc2_plants, rc2_total, rc2_avg = run_agent_eval("submission_rc2_terminal_horizon", "RC2 Control (Frozen Baseline)")
rc3_scores, rc3_plants, rc3_total, rc3_avg = run_agent_eval("submission_rc3_laboratory", "RC3-A Laboratory")

print("\n" + "=" * 105)
print("     COMPARATIVE HEAD-TO-HEAD LEADERBOARD     ")
print("=" * 105)
print(f"  {'Opponent / Seed':<26} | {'RC2 Control':>12} | {'RC3-A Lab':>12} | {'Net Lift':>12}")
print("-" * 105)
