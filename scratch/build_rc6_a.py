...
repl_crit = """    critical_target = min(target_hires, 4 if day <= 1 else 5 if day <= 4 else 7 if day <= 8 else 9 if day <= 14 else 11)"""
...
with open(r"D:\kaggriculture\submission_rc6_a.py", "w", encoding="utf-8") as f:
    f.write(code)

print("Created submission_rc6_a.py successfully!")
