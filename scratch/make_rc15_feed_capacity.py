...
# Replace the animal buying loop with Day-11 Feed Carrying Capacity Gate
...
new_animal_gate = """    # Calculate farm feed carrying capacity (1 wheat plot reliably supports 1.5 animals)
    tiles = obs.get("farms", [{}])[farm_id].get("tiles", [])
...
print("Created candidate_rc15_feed_capacity.py cleanly!")
