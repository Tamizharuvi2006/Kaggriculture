...
print("=" * 105)
print("     OFFICIAL 5-SEED GAUNTLET: RC2 CONTROL vs RC3-D TERMINAL REALIZATION     ")
print("=" * 105)

rc2_scores, rc2_plants, rc2_total, rc2_avg = run_agent_eval("submission_rc2_terminal_horizon", "RC2 Control (Frozen Baseline)")
rc3d_scores, rc3d_plants, rc3d_total, rc3d_avg = run_agent_eval("submission_rc3d_laboratory", "RC3-D Terminal Realization")

print("\n" + "=" * 105)
print("     COMPARATIVE HEAD-TO-HEAD LEADERBOARD     ")
print("=" * 105)
print(f"  {'Opponent / Seed':<26} | {'RC2 Control':>12} | {'RC3-D Lab':>12} | {'Net Lift':>12}")
print("-" * 105)
for _, _, opp_name in replays:
    s2 = rc2_scores[opp_name]
    s3d = rc3d_scores[opp_name]
    lift = s3d - s2
    print(f"  {opp_name:<26} | ${s2:>10,.0f} | ${s3d:>10,.0f} | ${lift:>+10,.0f}")
print("-" * 105)
total_lift = rc3d_total - rc2_total
print(f"  {'TOTAL AGGREGATE':<26} | ${rc2_total:>10,.0f} | ${rc3d_total:>10,.0f} | ${total_lift:>+10,.0f}")
print(f"  {'AVERAGE PER MATCH':<26} | ${rc2_avg:>10,.0f} | ${rc3d_avg:>10,.0f} | ${rc3d_avg - rc2_avg:>+10,.0f}")
print("=" * 105)
