...
# 3. Affluent Cow Expansion Gate on Day 11 (budget >= 10000, Cows only, herd <= feed capacity)
...
new_animal_gate = """    # Dynamic Herd Carrying Capacity check:
    ...
    for animal in ("COW", "SHEEP"):
        ...
        if day > 11: break
        # On Day 11: Ultra-Affluent Cow Gate (budget >= 10000, Cows only, herd <= capacity)
        if day == 11:
...
with open(r"D:\kaggriculture\scratch\candidate_rc15_affluent10k.py", "w", encoding="utf-8") as f:
    f.write(code)

print("Created candidate_rc15_affluent10k.py cleanly!")
