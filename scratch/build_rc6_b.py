with open(r"D:\kaggriculture\submission_rc6_a.py", "r", encoding="utf-8") as f:
    code = f.read()

# Revert land_reserve to 800 (requiring $1,800 cash before buying NE)
...
with open(r"D:\kaggriculture\submission_rc6_b.py", "w", encoding="utf-8") as f:
    f.write(code)

print("Created submission_rc6_b.py successfully!")
