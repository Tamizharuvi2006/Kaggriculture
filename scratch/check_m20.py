...
replay_path = r"D:\kaggriculture\reports\step5b\old_loss_gauntlet\raw_replays\95775674\episode-95775674-replay.json"
    ...
    for s in range(len(steps)-1):
        ...
        for o in act.get("market", []):
            if o and o[0] == "BUY_PRODUCT" and o[1] == "WHEAT":
                wheat_purchases += o[2] * obs["market"]["prices"].get("WHEAT", 25)
