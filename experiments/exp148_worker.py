"""EXP148 Multi-Opponent Worker: Evaluates Arms A, B, C, D across benchmark opponent suites."""
...
from experiments.test_exp148_proof import (
    agent_arm_a, agent_arm_b, agent_arm_c, agent_arm_d
)
...
def main():
    if len(sys.argv) < 3:
        print("Usage: python exp148_worker.py <bot_filename> <worker_id>")
        return
    ...
    out_file = os.path.join(REPORTS_DIR, f"exp148_part_{worker_id}.json")
