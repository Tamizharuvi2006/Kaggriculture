...
1. **Production Baseline (Frozen Control)**:
   * File: [`submission.py`](file:///D:/kaggriculture/submission.py)
...
2. **Aggressive Early Hedge Baseline (Frozen Control)**:
   * File: [`submission_rc3_h6.py`](file:///D:/kaggriculture/submission_rc3_h6.py)
...
3. **Adaptive Market-Response Baseline (Promoted Candidate)**:
   * File: [`submission_rc4_1_clean.py`](file:///D:/kaggriculture/submission_rc4_1_clean.py)
